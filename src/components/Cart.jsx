        ...
        <div className='flex flex-col justify-center items-center'>
           {cartItems?.length>0 ? 
            <div id='cart-with-items'>
              ...
              <button onClick={()=>removeFromCart(item.name)} className='cursor-pointer border border-[#AD8A85] rounded-full p-1 w-5.5 h-5.5 hover:border-black'><img src="./assets/images/icon-remove-item.svg" className='w-3 h-3' alt="delete-icon" /></button>
                </div>
              ))}
            ...
            <div className='flex flex-row gap-2 items-center justify-center mt-6'><img src="./assets/images/icon-carbon-neutral.svg" alt="carbon-neutral-icon" /> <p>This is a <b>carbon-neutral</b> delivery</p></div>
            ...
            :
             <div id="cart-empty" className='flex flex-col justify-center items-center'>
              <img src="./assets/images/illustration-empty-cart.svg" alt="empty-cart-icon" className='w-[128px] h-[128px]'/>
